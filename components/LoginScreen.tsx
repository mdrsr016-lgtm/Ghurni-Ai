...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#1C1C1E] flex flex-col md:flex-row">
        
        {/* Left Side (Dark) - Branding & Visuals */}
        <div className="w-full md:w-5/12 bg-[#1C1C1E] relative p-6 md:p-12 lg:p-16 flex flex-col justify-between text-white shrink-0 md:min-h-screen transition-all duration-500">
           ...
           {/* Main Heading & Mockup */}
           <div className="relative z-10 mt-6 md:mt-12 md:mb-12 flex-1 flex flex-col md:justify-center">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight mb-4 tracking-tighter transition-all duration-300">
                <span key={isSignUp ? 'start' : 'discover'} className="inline-block animate-fade-in-up">
                    {isSignUp ? 'Start' : 'Discover'}
                </span>
                <br />
                <span className="animate-fade-in-up animation-delay-100 inline-block">your next</span><br />
              ...
              {/* Phone Mockup visual */}
              <div className="hidden md:block mt-8 relative w-48 lg:w-64 h-80 lg:h-96 bg-gray-800 rounded-[3rem] border-4 border-gray-700 mx-auto md:mx-0 shadow-2xl transform rotate-[-12deg] hover:rotate-0 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] overflow-hidden group animate-fade-in-up animation-delay-300">
                  <img 
                  ...
                  <div className="absolute bottom-6 left-4 right-4 bg-white/10 backdrop-blur-md p-3 rounded-2xl border border-white/20 shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                    <div className="flex justify-between items-end">
                       <div>
                         <p className="text-xs text-gray-300">Flight to</p>
                         <p className="text-lg font-bold">Tokyo, JPN</p>
                       </div>
                       <div className="text-xl font-bold text-orange-400">$897</div>
                    </div>
                  </div>
              </div>
           </div>
        ...
        <div className="flex-1 md:w-7/12 bg-white flex flex-col justify-between rounded-t-[30px] md:rounded-tr-none md:rounded-l-[50px] relative z-20 shadow-[0_-10px_40px_rgba(0,0,0,0.2)] md:shadow-none transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]">
           <div className="p-8 md:p-16 lg:p-24 flex flex-col flex-1 justify-between">
               {/* Top Bar */}
               <div className="flex justify-between items-center mb-8 md:mb-0 animate-fade-in">
               ...
               {/* Footer */}
               <div className="flex flex-col sm:flex-row justify-between items-center text-xs text-gray-400 mt-8 md:mt-0 gap-4 animate-fade-in animation-delay-500">
